...
def train(epochs, BATCH_SIZE, weights=False):
    ...
    training_data = Data_Supplier(path='', batch_size=BATCH_SIZE encoder=coder_grey)
    ...
    for epoch in range(epochs):
        ...
        print("Number of batches", training_data.batches)
        for index in range(training_data.batches):
            ...
            # dump training progress optional (TODO)
